package sudoku.projeto.dio;

import sudoku.projeto.dio.model.Board;
...
import static sudoku.projeto.dio.util.BoardTemplate.BOARD_TEMPLATE;
...
public class Main {
    ...
    private static void removeNumber() {
        ...
        var row = runUntilGetValidNumber(0,8);
        System.out.printf("informe o número que vai sair d a posição [%s,%s]\n", col, row);
    ...
    private static void showGameStatus() {
        ...
        System.out.printf("O jogo atualmente se escontra %s \n", board.getStatus().getLabel());
        if(board.hasErrors()){
    ...
    private static void clearGame() {
        ...
        System.out.println("tem certeza que deseja Limpar o jogo? todo progresso sera perdido");
        var confirm = scanner.next();
        while (!confirm.equalsIgnoreCase("sim") && !confirm.equalsIgnoreCase("nâo")){
    ...
    private static void finishGame() {
        ...
        if(board.gameIsFinished()){
            ...
            System.out.println("Você ainda preencher algum espaço ");
        }
    }
